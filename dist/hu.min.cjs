...
function is(...values) {
    ...
    const isFunctionEqual = (...functions) => {
    ...
    switch (typeof firstValue) {
        ...
        // eslint-disable-next-line @typescript-eslint/ban-types
        case "function": return isFunctionEqual(firstValue, ...restValues);
        // compare object by keys recursively
        case "object":
            if (firstValue === null)
                return restValues.every((value) => value === null);
            switch (firstValue.constructor) {
                // compare arrays by their values
                case Array: return isArraysEqual(firstValue, ...restValues);
                // compare dates by their millisecond representation
                case Date: return isDateEqual(firstValue, ...restValues);
                // compare regular expressions by their source code
                case RegExp: return isRegExpEqual(firstValue, ...restValues);
                default: return isObjectEqual(firstValue, ...restValues);
            }
...
async function IPify() {
    try {
        return await (await axios$1.get("https://api.ipify.org?format=json")).data.ip;
    }
    catch (error) {
 ...
 */
function searchParamsSerializer(url) {
    const params = {};
...
var Handy = /*#__PURE__*/Object.freeze({
  __proto__: null,
  IPify: IPify,
...
//# sourceMappingURL=hu.min.cjs.map
